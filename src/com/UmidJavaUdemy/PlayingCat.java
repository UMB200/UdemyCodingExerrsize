...
public class PlayingCat {
    public static boolean isCatPlaying(boolean summer, int temperature){
        ValueRange vrSummer = ValueRange.of(25, 45);
        ValueRange vrOther = ValueRange.of(25, 35);
        if(summer && vrSummer.isValidValue(temperature)){
            return true;
        }
        if(!summer && vrOther.isValidValue(temperature)){
            return true;
        }
        else
            return false;
