...
public class SpeedConverter {
    ...
    public static long toMilesPerHour(double kilometersPerHour){
        ...
        //return rounded(kilometersPerHour * 0.621371); // convert miles to kilometers
        return Math.round(kilometersPerHour * 0.621371); // convert kilometers to miles
...
//    }
    ...
    public static void printConversion(double kilometersPerHour){
        ...
        if(kilometersPerHour >= 0.0) {
            //roundRes = rounded(kilometersPerHour * 1.6); // convert kilometers to miles
            roundRes = Math.round(kilometersPerHour * 0.622); // convert kilometers to miles
            System.out.println(kilometersPerHour + " km/h = " + roundRes + " mi/h");
        }
        else
